...
- Players who first appear as active players after the cutoff start at the current minimum filtered
  active-player score, matching the normal mid-game join floor behavior.
